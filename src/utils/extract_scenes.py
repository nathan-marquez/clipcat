...
def extract_scenes(video_path, id):
    ...
    for i in range(10):
        ...
        frame_file = os.path.join(output_folder, f"{i}.png")  # Save as PNG in the specified output folder
...
if __name__ == "__main__":
    ...
    id = 2  # Update this path to your desired output directory
